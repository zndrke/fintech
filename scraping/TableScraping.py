...
for i in range(0, 60):
    ...
    for index, value in enumerate(tablerow):
        if index != 0:
            ...
            jlink = value.find_elements_by_tag_name('td')[5].text
            print(type, address, pay, size, jlink)
    
    elementButton = driver.find_elements_by_xpath('//*[@id="list"]/tbody/tr[4]/td/ul/a['+str(i)+']')
